...
export default class ConfirmationCodeInput extends Component {
  ...
  componentDidUpdate(nextProps) {
    if (nextProps.defaultValue != this.props.defaultValue && this.props.defaultValue && this.props.defaultValue.length)
    {
      let currentArr = this.state.codeArr;
      let newDefaultValue = this.props.defaultValue;
      for (var i = 0; i < newDefaultValue.length; i++)
      {
